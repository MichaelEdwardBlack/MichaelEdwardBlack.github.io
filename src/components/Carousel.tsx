...
export const Carousel = ({ currentPage, direction, onChange, pages, ...props }: CarouselProps) => {
  ...
  function detectPaginationGesture(event: MouseEvent | TouchEvent | PointerEvent, info: PanInfo) {
